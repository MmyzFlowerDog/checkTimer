...
#import "PracticeTimer.h"

dispatch_source_t timer;

static int _timeout;

@interface PracticeTimer ()
...
@implementation PracticeTimer
singleton_implementation(PracticeTimer)
...
+ (void)timerWithTimeout:(int)timeout handlerBlock:(HandlerBlock)handlerBlock finish:(TimerBlock)finish {
    [[self sharedPracticeTimer] createTimerWithTimeout:timeout handlerBlock:handlerBlock finish:finish];
}
...
+ (void)stopGCDTimer {
    ...
    [[self sharedPracticeTimer] stopGCDTimer];
}
@end
